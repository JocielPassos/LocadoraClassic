...
namespace LocadoraClassic.DAL
{
    public class CategoriaDAL
    {
        public void InserirCategoria(Categoria categoria)
        {
            ...
            comando.CommandText = "INSERT INTO categoria(nome, valordiaria)values(@nome, @valordiaria)";
        ...
        public List<Categoria> ObterCategorias1()
        {
            //Abrir a Conexão
            Conexao.Instance.Open();
            // MySqlCommand
        ...
        public void AtualizarGenero(Categoria categoria)
        {
            // Abrir a Conexão
            Conexao.Instance.Open();
